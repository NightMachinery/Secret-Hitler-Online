...
class LoginPageContent extends Component {
    ...
    render() {
        ...
        let items = [
            <img className={"login-page-gif"} src={placePolicyGif} onDragStart={handleDragStart} alt={"A policy tile being placed on the board."}/>,
            <img className={"login-page-gif"} src={showPolicyGif} onDragStart={handleDragStart} alt={"An animated folder revealing a policy tile."}/>,
            <img className={"login-page-gif"} src={showVotesGif} onDragStart={handleDragStart} alt={"An animation showing all the cast votes."}/>
        ];
        return (
            <div className={"login-page-description-container"}>
                <div className={"login-page-description-text-container login-page-description-card"}>
                    <h2 className={"login-page-description-text-header"}>What is Secret Hitler Online?</h2>
                    <p className={"login-page-description-text"}>
                ...
                <div className={"login-page-gif-container login-page-description-card"}>
                    {items}
                </div>
                <div className={"login-page-description-text-container login-page-description-card login-page-description-meta"}>
                    <p className={"login-page-description-text"}>
