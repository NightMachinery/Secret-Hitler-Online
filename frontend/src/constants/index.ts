...
export const MAX_FAILED_CONNECTIONS = 50;
...
export const COMMAND_REGISTER_POLICY_CLAIM = "register-policy-claim";
...
export const STATE_POLICY_CLAIMS = "POLICY_CLAIMS"; // President and chancellor are reporting policy cards.
